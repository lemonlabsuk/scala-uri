# scala-uri
 ...
 > Master is for `scala-uri` `0.4.x`. There are making breaking API changes in `0.4.0-SNAPSHOT`. If you would like something stable, please use [0.3.x](https://github.com/theon/scala-uri/tree/0.3.x).
